export default {
  ...
  headerInformation: {
    ...
    warehouseName: '仓库名称',
    operator: '操作人',
    quantityToBePutOnShelves: '待上架重量(g)',
    shelfLocation: '上架库位',
    deliveryOrderNo: '出库单号',
    issueType: '出库类型',
    sourceDocNo: '来源单据号',
    pickedQuantity: '已拣选重量(g)',
    locationAddress: '库位地址',
    pickingQuantity: '拣选重量(g)',
    tray: '托盘',
    storage: '储位',
    issuedBy: '下发人',
    issuedTime: '下发时间',
    ...
    quantityToBePicked: '待拣货重量(g)',
    pickedquantity: '已拣货重量(g)',
    axisX: 'X轴灯号',
    axisY: 'Y轴灯号',
    xAxis: '---X轴',
    yAxis: '---Y轴',
    pickingStorage: '拣货储位',
    receivedQuantity: '已入库重量(g)',
    locationCode: '库位码',
    address: '地址',
    contact: '联系方式',
    theContact: '联系人',
  ...
  // 单据/打印条码
  printBar: {
    totalWarehousingQuantity: '入库总重量(g)',
    // 输入框提示
    minimumQuantityOfSinglePackage: '最小单包重量(g)',
    barcodeQuantity: '条码重量(g)',
    touchTool: '每个模具生成唯一码,重量(g)为1，进行模具生命周期管理',
  ...
  inTaskPopup: {
    ...
    receiptQuantity: '入库重量(g)',
    // 输入框提示
    enterReceiptQuantity: '请输入入库重量(g)',
    axisX: '---X轴',
    axisY: '---Y轴',
  ...
  manualSelection: {
    manualPicking: '手动练选',
    picked: '已拣',
    numberOfLocks: '锁定重量(g)',
    inventoryLock: '盘点锁定',
  },
  // 出库/复核
  toReview: {
    toReview: '复核',
    quantityToBePicked: '应拣重量(g)',
  },
  // 出库/退料
  returnMaterial: {
    returnMaterial: '退料',
  ...
  executeDelivery: {
    ...
    outboundQuantity: '出库重量(g)',
    startContainer: '启动货柜',
    depositInContainer: '存入货柜',
    // 输入框提示
    pleaseEnterTheIssueQuantity: '请输入出库重量(g)',
  ...
  stockManagement: {
    ...
    // 物料库存
    // 输入框提示
    theTotalNumber: '总重量(g)',
    lockTheNumber: '锁定重量(g)',
    theNumberOfAvailable: '可用重量(g)',
  ...
  equipmentManagement: {
    ...
    currentStorageQuantity: '当前存放重量(g)',
    maximumStorageQuantity: '最多存放重量(g)',
  ...
  basicInformation: {
    ...
    xAxisStorageQuantity: 'X轴存放重量(g)',
    yAxisStorageQuantity: 'Y轴存放重量(g)',
    addLoadWith: '添加载具',
    ...
    pleaseEnterTheQuantityOfXAxisStorage: '请输入X轴存放重量(g)',
    pleaseEnterTheQuantityOfYAxisStorage: '请输入y轴存放重量(g)',
    ...
    attributeGroup: '属性组',
    numberOfPackages: '包装重量(g)',
    nameOfVehicleBox: '载具箱名称',
    theLengthOfThe: '长度（mm）',
    theWidthOfThe: '宽度（mm）',
    maximumStorageQuantity: '最大存放重量(g)',
    chooseAVehicle: '选择载具',
    toGenerateTheNumber: '生成重量(g)',
    ...
    pleaseEnterPackingQuantity: '请输入包装重量(g)',
  ...
  handPick: {
    ...
    materialName: '物料名称',
    pickingQuantity: '拣选重量(g)',
    pickedQuantity: '已拣重量(g)',
    cancel: '取消',
    recheckQuantity: '复核重量(g)',
    company: '单位',
    locationCode: '库位码',
    warehouseName: '仓库名称',
    areaName: '区域名称'
  ...
  presentationOfWarehousingDocuments: {
    ...
    numberOfBarCodesInAPacket: '请输入正确的单包条码重量(g)',
    editTheEntryList: '编辑入库单',
    createAnEntryList: '创建入库单',
    pleaseEnterTheWarehouseEntryNumber: '请输入入库单号',
    pleaseSelectWarehouse: '请选择仓库',
    pleaseEnterTheNumberOfPackets: '请输入单包重量(g)',
    pleaseEnterTheNumberOfCorrectFormats: '请输入正确格式的重量(g)',
    pleaseEnterTheCorrectNumberOfTagGeneration: '请输入正确的标签生成重量(g)',
    ...
    unableToStockIn: ' 未获取到正确的标签重量(g)，无法入库',
    excessQuantity: 'Receipt quantity exceeds receivable quantity | 入库重量(g)超过应收重量(g)',
  ...
  deliveryPrompt: {
    ...
    reviewFailed: '复核失败',
    reviewSucceed: '复核成功',
    pleaseConfirmTheRecheckQuantity: '请确认复核重量(g)',
    theRecheckQuantityMustBe: ' 复核重量(g)必须为小于或等于拣选重量(g)',
    recheckQuantityMustBeNumericOrNot0: '复核重量(g)必须为数值或者不为0',
    deliverySucceeded: '出库成功',
    pickingHasNotStarted: '尚未开始拣货',
    reviewCompleted: '尚未完成拣货或已复核完毕',
    pleaseEnterPickingQuantity: '请输入拣选重量(g)',
    availableStockQuantity: '拣选重量(g)应小于可用库存重量(g) ',
    lessThanTheRequiredQuantity: '|拣选重量(g)必须为小于需求重量(g)',
    pickingQuantityMustBeNumericOrNot0: '拣选重量(g)必须为数值或者不为0',
  ...
  inventoryTips: {
    ...
    countQuantityMustBeNumeric: '盘点重量(g)必须为数值',
    ...
    pleaseEnterTheCountingQuantity: '请输入盘点重量(g)',
    pleaseEnterTheQuantityInTheCorrectFormat:' 请输入正确格式的重量(g)（包含两位小数的数字或者不包含小数的数字）',
    pleaseEnterTheCountingQuantityInTheCorrectFormat:'请输入正确格式的盘点重量(g)（包含两位小数的数字或者不包含小数的数字） ',
  ...
  basicTips: {
    ...
    beyondXAxis:' 超出X轴方向可存放重量(g)，最多存放',
    beyondYAxis:' 超出Y轴方向可存放重量(g)，最多存放',
    ...
    pleaseEnterTheMaterialName: '请输入物料名称',
    pleaseEnterTheMaximumStorageQuantity: '请输入最大存放重量(g)',
